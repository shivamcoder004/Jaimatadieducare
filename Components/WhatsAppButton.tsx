...
export default function WhatsAppButton() {
  ...
  // Agar phone2 hai toh wo use hoga, nahi toh default number
  const whatsappNumber = tenant?.footer?.phone2 || "918252895483";

  // Number se spaces ya special characters hatane ke liye
  const cleanNumber = whatsappNumber.replace(/\D/g, "");

  // Link format setup (agar country code nahi hai toh 91 add kar dega)
  const finalLink = cleanNumber.startsWith("91") 
