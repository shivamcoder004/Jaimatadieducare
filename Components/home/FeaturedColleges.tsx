...
const COLLEGES = [
  { id: 1, name: "BABA FARID", logo: "/babafarid.webp" },
  { id: 2, name: "GURU KASHI UNIVERSITY", logo: "/Gurukashi.png" },
  { id: 3, name: "RIT ROORKEE", logo: "/rit.png" },
  { id: 4, name: "SHRI RAM", logo: "/shreeramcollege.jpeg" },
  // { id: 5, name: "TULA'S INSTITUTE", logo: "" },
  { id: 6, name: "JAIPUR NATIONAL UNIVERSITY", logo: "/jaipurnational.png" },
  { id: 7, name: "JAGANNATH UNIVERSITY", logo: "/jagannath.jpg" },
  { id: 8, name: "VGU JAIPUR", logo: "/vgu.jpeg" },
];
